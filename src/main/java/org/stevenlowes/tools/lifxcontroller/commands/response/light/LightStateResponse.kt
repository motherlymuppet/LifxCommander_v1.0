...
data class LightStateResponse(val color: Color = Color(),
                              val reserved1: Int = 0,
    ...
    companion object {
        fun loadFrom(byteArray: ByteArray): LightStateResponse {
            val color = Color()
            ...
            return LightStateResponse(color, reserved1, power, label, reserved2)
        }
    }
}