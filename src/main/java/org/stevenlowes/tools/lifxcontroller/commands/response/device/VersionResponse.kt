...
data class VersionResponse(val vendor: Long = 0, val product: Long = 0, val version: Long = 0) : ResponseCommand(33) {

    companion object {
        fun loadFrom(byteArray: ByteArray): VersionResponse {
            var vendorBinStr = ""
            ...
            return VersionResponse(vendor, product, version)
        }
    }
